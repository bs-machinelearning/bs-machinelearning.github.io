...
with an AdamW and one-cycle schedule on $224{\times}224$ inputs.

Augmentations include resized crops, flips, affine transforms, color jitter, blur, JPEG noise, coarse dropout, and ImageNet normalization. We use SmoothL1 loss over total from the sum of the predicted types.
...
The dataset consists of 130 proprietary warehouse images, with a 80-20 train-validation split.
